...
sav = '29-Mar-2014-bk-subtracted-iris-hmi-area-energies-Jan20-2016.sav'
sv = readsav(filepath+sav, verbose = True) 
#################################################################
#EVERYTHING BELOW THIS LINE NEEDS TAILORING FOR THE NEW SAV FILE
#################################################################
